...
<body>
  ...
  <!-- Begin Navbar -->
  <div id="nav">
    <div id= "nav"class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php" id="logos">A N G E L E S</a>
        </div>
        ...
        if($_SESSION['usuario']=="admin"):
         ...
         <?php 
          ...
          <li class="dropdown" >
            <a id="drop" href="#" style="color: red"  class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user"></i></a>
            <ul class="dropdown-menu">
              <li>
              Usuario: <?php echo $_SESSION['usuario']; ?>
              <a style="color: red" href="../procesos/salir.php"><span class="glyphicon glyphicon-off"></span> Salir</a></li>
